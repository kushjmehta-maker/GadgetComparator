...
export default async function DiscoverPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-[var(--max-width)] px-4 py-8">
      <div className="mb-6">
        <p className="text-xs font-medium uppercase tracking-wider text-slate-400">Discover</p>
        ...
        <>
          ...
          {rankings.length > 1 && (
            <div className="mb-6 space-y-3">
              <h2 className="text-sm font-semibold text-slate-700">All Recommendations</h2>
